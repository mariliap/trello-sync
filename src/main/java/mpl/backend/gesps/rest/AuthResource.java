...
import mpl.backend.gesps.auth.AuthUtils;
import mpl.backend.gesps.auth.PasswordService;
import mpl.backend.gesps.model.Token;
import mpl.backend.gesps.model.User;
import mpl.backend.gesps.model.User.Provider;
import mpl.backend.gesps.db.UserDAO;
...
//  @Path("trello")
//  //@UnitOfWork
//  public Response loginTrello(@Valid final Payload payload,
//                              @Context final HttpServletRequest request) throws JOSEException, ParseException,
//          JsonParseException, JsonMappingException, IOException {
//    final String accessTokenUrl = "https://trello.com/1/OAuthGetRequestToken";
//    final String peopleApiUrl = "https://www.googleapis.com/plus/v1/people/me/openIdConnect";
//    Response response;
//
//    // Step 1. Exchange authorization code for access token.
