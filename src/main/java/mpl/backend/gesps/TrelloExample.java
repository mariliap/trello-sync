...
/**
 * Created by Marilia on 22/01/2018.
 */
...
public final class TrelloExample {
    ...
    public TrelloExample() {
    }

    public static void main(String... args) throws IOException, InterruptedException, ExecutionException {
        TrelloExample example = new TrelloExample();
        example.logarTrello();
    }

    public void logarTrello() throws IOException, InterruptedException, ExecutionException {
        ...
        System.out.println(service.getAuthorizationUrl(requestToken)+"&name=HelloMP");
